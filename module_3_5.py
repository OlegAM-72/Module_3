...
#  2/.Создайте переменную str_number и запишите строковое представление(str) числа
#      number в неё.
...
#     Таким образом вы умножите первую цифру числа на результат работы этой же функции
#     с числом, но уже без первой цифры.
...
#  get_multiplied_digits(40203) -> 4 * get_multiplied_digits(203) -> 4 * 2 *
#  get_multiplied_digits(3) -> 4 * 2 * 3